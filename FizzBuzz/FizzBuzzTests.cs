...
// 
// Project: "FizzBuzz", "FizzBuzzTests.cs" was last formatted by Protiguous on 2019/11/07 at 2:07 PM.
...
namespace FizzBuzz {
    ...
    public class FizzBuzzTests {
        ...
        [NotNull]
        public IFizzBuzzGrader Teacher { get; } = new FizzBuzzTeacher();

        [Benchmark]
        [Fact]
        public void TestClassicFizzBuzz() {

            this.Teacher.LoadExpectedOutputs( "ExpectedOutput.1-100.txt" );

            var stopwatch = Stopwatch.StartNew();

            try {
                Debug.Write( "Create student " );
                var student = new ClassicFizzBuzzTest( 1, 100 );
                Debug.WriteLine( $"took {stopwatch.Elapsed.TotalMilliseconds} ms." );

                Debug.WriteLine( "Student taking test..." );
                student.TakeTest();
                ...
                stopwatch.Stop();
                Debug.WriteLine( $"{nameof( ClassicFizzBuzzTest )} took {stopwatch.Elapsed.TotalMilliseconds:N} ms." );
            }
        }
